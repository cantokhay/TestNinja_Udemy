...
namespace TestNinja.Mocking
{
    ...
    public class HousekeeperService //static deleted
    {
        ...
        public void SendStatementEmails(DateTime statementDate) //static deleted, bool deleted, void added
        {
            var housekeepers = _unitOfWork.Query<Housekeeper>();

            foreach (var housekeeper in housekeepers)
            {
                //if (housekeeper.Email == null) //we catch the bug here by testing it
